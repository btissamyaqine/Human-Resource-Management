				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							...
							<!-- Header -->
								<header id="header">
									<a href="#" class="logo"><strong></strong>Gestion des ressources humaines de la Province de Khouribga</a>
									<ul class="icons">
										...
										<li><a href="admin/index.php"><span class="label">LogOut</span></a></li>
									</ul>
								</header>